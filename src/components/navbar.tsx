...
const NavBar: React.FC = () => {
  return (
    <nav className="bg-background dark:bg-dark-background fixed w-full z-20 top-0 start-0 border-b border-border-color dark:border-dark-border-color">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4 h-16">
        <Button className="flex items-center space-x-4 rtl:space-x-reverse bg-primary text-primary-foreground dark:bg-dark-primary dark:text-dark-primary-foreground">
